...
var language={
    "zh":{
		...
		'v23':'CaoXianCoin',
		'v24':' CaoXianCoin 。CXB是平台的代币，持有代币，可以享受交易分红。  总供应量 1,000,000,000,000,000，发行初始销毁50%到黑洞。空投总量的10%， 每份91亿个(发送100亿 到账91亿 系统扣除了9%手续费)， 流动性挖矿20%  2,00,000,000,000,000枚。  ',
		
		'v241':'CaoXianCoin。CXB是平台的代币，持有代币，可以享受交易分红。  总供应量 1,000,000,000,000,000，发行初始销毁50%到黑洞。空投总量的10%， 每份91亿个(发送100亿 到账91亿 系统扣除了9%手续费)， 流动性挖矿20%  2,00,000,000,000,000枚。',		
		
		'v26':'领取空投',
		'v27':'CaoXianCoin(CXB) 空投总量为供应量的10%，共计 10,000,000,000,000 枚. 每一个BSC地址可以领取91亿枚空投(发送100亿 到账91亿 系统扣除了9%手续费)。推荐好友领取空投可以获得50%的空投奖励',
		'v30':'运营机制', 
		'v31':'每笔交易共收取9%的手续费',
		'v33':'1%用于销毁 减少总量',
		...
		'v13':'流动性挖矿',
		'v14':'流动性挖矿总量为20% 共计 2,000,000,000,000 枚，后期上线，持有CXB即可挖矿。',
		'v15':'第一年',
		'v16':'第二年',
		'v17':'第三年',
		'v18':'第四年',
    ...
    "en":{
        ...
        'lan25':'',
        'lan26':'',
        'lan27':'2. 0.01BNB must be paid as a miner gas fee to receive  airdrops',
        ...
        'msg7':'Please make sure the account balance is greater than 0.01BNB',
        'msg8':'Sorry, your credit is running low',
        'msg9':'Please enter the correct BNB quantity',
		...
		'v10':'Airdrop',
		'v23':'CaoXianCoin',
		'v24':' CaoXianCoin, we are going to be like the honey badger, brave, determined, tenacious. CXB are tokens for the platform, and holders of tokens are entitled to a trading bonus. With a total supply of 1,000,000,000,000,000,000, the issue initially destroyed 50% to the black hole. 10% of the total airdrop volume, 10,000,000,000,000,000,20% into the market, 20% on-line liquidity mining, 2,000,000,000  ',

		'v241':' CaoXianCoin, we are going to be like the honey badger, brave, determined, tenacious. CXB are tokens for the platform, and holders of tokens are entitled to a trading bonus. With a total supply of 1,000,000,000,000,000,000, the issue initially destroyed 50% to the black hole. 10% of the total airdrop volume, 10,000,000,000,000,000,20% into the market, 20% on-line liquidity mining, 2,000,000,000 ',		
		
		'v26':'Receive airdrop',
		'v27':'This airdrop CXB The total quantity 10%.Where as CXB The scarcity of information，each BSC Address restriction participating in airdrop  9,100,000,000. Each participant can get CXB reward  50% 。',
		...
		'v14':'Liquidity Mining  total 20%  2,000,000,000,000,000 pieces, late on-line, holding CXB can dig. ',
		'v15':'First year',
		'v16':'The second year',
		'v17':'The third year',
		'v18':'The fourth year',
